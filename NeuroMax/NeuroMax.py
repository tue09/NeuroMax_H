        ...
        if self.use_MOO == 1:
            if self.weight_loss_CTR == 0:
                rst_dict = {
                    'loss_': loss,
                    #'loss_CTR': loss_CTR,
                    'loss_x1': loss_TM + loss_ECR + loss_GR + self.coef_ * loss_InfoNCE,
                    'loss_x2': loss_TM + loss_ECR + self.coef_ * loss_GR + loss_InfoNCE,
                    'loss_x3': loss_TM + self.coef_ * loss_ECR + loss_GR + loss_InfoNCE,
                    'loss_x4': self.coef_ * loss_TM + loss_ECR + loss_GR + loss_InfoNCE,
                    'lossTM': loss_TM,
                    'lossECR': loss_ECR,
                    'lossGR': loss_GR,
